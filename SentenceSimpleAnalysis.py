...
class SentenceSimpleAnalysis (object):
  ...
  chckfile = "/home/prin/pyltp/checkcomm.txt"
  exchfile = "/home/prin/pyltp/exchangecomm.txt"
  ...
  symbols = set([u'，', u'。', u'！', u'？'])
  virtualwords = [u'吧', u'啊', u'吗', u'儿', u'请', u'帮忙', u'帮', u'一下', u'想', u'想要', u'想让你', u'我的', u'我', u'去', u'到', u'还', u'是', u'里面', u'里', u'都', u'了']
...
#      elif self.isExchWords(wordlist):
...
if __name__ == '__main__':
  ...
  print (ssa.processSentence(u"查余额"))
  ...
  print (ssa.processSentence(u"转给小明100元"))

  print (ssa.processSentence(u"转给张三100元"))
  print (ssa.processSentence(u"查询最近三笔交易记录"))
  print (ssa.processSentence(u"骨头里有多少钱"))
  print (ssa.processSentence(u"请帮我转三百元给小明"))
  print (ssa.processSentence(u"查下我最近5个月的交易历史记录"))
  print (ssa.processSentence(u"查下我三月份的交易历史记录"))
  print (ssa.processSentence(u"查上两个月的转账记录"))
#"""
